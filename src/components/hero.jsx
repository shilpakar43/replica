                    ...
                    <Row>
                        <Col xs={12} sm={12} md={12} lg={7} xl={7} className='bg-primary-subtle mt-4 rounded-5 mb-3'>
                            <Row>
                                ...
                                <Col xs={4} sm={4} md={3} lg={2} xxl={2} className="position-relative mt-0 d-flex justify-content-end ">
                                    <Dropdown>
                                        <Dropdown.Toggle varient="success" id="dropdown-basic" className='border-0 mt-0' ><br />
                        ...
                        <Col xs={12} sm={12} md={12} lg={5} xl={5} className='ms-2 mt-5 me-0' >
                            <Row>
                                    ...
                                    <Accordion.Header>
                                        ...
                                        <Col xs={9} sm={10} md={6} lg={6} xl={7} className='mt-3'>
                                            <Row>
                                                ...
                                                <Row>
                                                    <Col sm={12} md={12} lg={12} xl={12} className='fs-n'>
                                                        $10/hour
                                                    </Col>
                                                </Row>
                                            </Row>
                                    ...
                                    <Accordion.Header>
                                        ...
                                        <Col xs={11} sm={10} md={8} lg={10} xl={10} className='mt-3'>
                                            <Row>
                                                ...
                                                <Col xs={4} sm={2} md={4} lg={2} xl={2} className='mt-0'>
                                                    <Badge pill bg="secondary">
                                                        Paid
                                                    </Badge>
                                                </Col>
                                ...
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header>
                                        ...
                                        <Col xs={11} sm={10} md={6} lg={6} xl={7} className='mt-3'>
                                            <Row>
                                                <Col xs={7} sm={10} md={10} lg={10} xl={10} >
                                                    <h4 className='m-0'>Web Designing Project</h4>
                                                </Col>
                                                <Col xs={5} sm={2} md={2} lg={2} xl={2} className='mt-0'>
                                                    <Badge pill bg="secondary">
                                                        Not paid
                                                    </Badge>
                                                </Col>
